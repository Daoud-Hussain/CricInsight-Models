...
# Start video capture using the webcam (0 for default camera)
...
def extract_real_time_features(pose_landmarks):
    """
...
while cap.isOpened():
    ...
    if result.pose_landmarks:
        ...
        features = extract_real_time_features(result.pose_landmarks.landmark)
    ...
    # Show the frame
    cv2.imshow('Real-Time Shot Detection', frame)
